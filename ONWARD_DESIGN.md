...
6. **Sidebar refactor** — tackle last, once all the above is in place and it's clear exactly what options need to live in it (project name display, new project, open project, submit, view summary, export, settings).
